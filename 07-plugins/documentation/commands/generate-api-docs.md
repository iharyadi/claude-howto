...
description: Generate comprehensive C++ API documentation from header files and module interfaces
---

# C++ API Documentation Generator

Generate complete C++ API documentation with Doxygen style:

1. Scan header files (`.hpp`, `.h`) and module interfaces (`.cppm`)
2. Extract class definitions, function signatures, template declarations
3. Identify existing documentation and suggest Doxygen improvements
4. Add documentation for class invariants, Concepts/requirements, pre-conditions, post-conditions
5. Create markdown with examples in `/docs/api.md`
